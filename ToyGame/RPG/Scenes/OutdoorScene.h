...
//  KitGame の FieldScene と同じ形（IScene の4フェーズ：
//  DefineEnvironment/DefineWorld/SpawnCharacters/DefineUI + Deploy* ヘルパー）
//  で構成する。
//=============================================================================
...
{
public:
    // Hero/Shiro/Wolf/Stan/MagicBolt/HealBurst は前方宣言のみのため、それらの
...
private:
    ...
    std::unique_ptr<class Stan>                mStan;
