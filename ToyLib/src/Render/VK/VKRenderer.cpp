...
void VKRenderer::BeginFrame()
{
    ...
    {
        // OnWindowResized() で Swapchain 作り直す想定（今はreturnでもOK）
        return;
    }
    ...
    // 4) clear color（IRenderer の mClearColor）
